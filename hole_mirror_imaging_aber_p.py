...
from classes.Fresnel_Kirchhoff_diffraction_parallel import FK_diffraction
from multiprocessing import Pool, cpu_count

from classes.spherical_mirror_aberrations import mirror_aberration
...
if __name__ == '__main__':
    ...
    # #aberrations
    # tilt=10 #degree
    # Ph=mirror_aberration(2*f,tilt,Xin2,Xin2)
    # plt.pcolormesh(Xin2,Xin2,Ph)
    # plt.show()
    # Ein2*=np.exp(1j*Ph)
