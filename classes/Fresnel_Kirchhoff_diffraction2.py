...
class FK_diffraction():
    ...
    def propagate(self):
        ...
        #Sympsons coefficients
        Sx=self.SympsCof(Nx)
        print(Sx)
        self.Eout=np.array([[-1j/lam*dx*dy/9*np.sum(Sx*self.Ein*self.R_part(XinM,YinM,x,y,self.L)*
    ...
    def SympsCof(self,shape):
        """generates 2d Sympsons coefficints of shapeXshape size"""
